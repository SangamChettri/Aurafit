...
const WorkoutScreen = () => {
  ...
  const loadWorkouts = async () => {
    try {
      ...
      if (response.data.success) {
        // Backend returns { data: { workouts: [...], pagination: {...} } }
        const workoutsData = response.data.data.workouts || [];
        console.log('📊 Extracted workouts data:', workoutsData);
        console.log('📈 Number of workouts:', workoutsData.length);
    ...
    navigation.navigate('WorkoutLog', {
      templateWorkout: {
        ...
        exercises: item.exercises?.map(ex => ({
          ...
          category: ex.libraryRecord?.category,
          equipment: ex.libraryRecord?.equipment,
          sets: ex.sets.map(s => ({
            ...s,
  ...
  const handleDeleteWorkout = async (workoutId: string) => {
    try {
      ...
      Alert.alert('Failed to delete workout', 'Please try again');
    } catch (error) {
        ...
        >
          ...
          <View style={styles.workoutStats}>
            ...
            <View style={styles.statItem}>
              ...
              <Text style={styles.statLabel}>Total kgs</Text>
            </View>
          </View>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.personalizedButtonContainer}>
        <TouchableOpacity
          ...
          onPress={() => navigation.navigate('PersonalizedWorkoutsScreen' as never)}
        >
          <Ionicons name="list-outline" size={18} color="#ffffff" />
          <Text style={styles.personalizedButtonText}>Personalized Workouts</Text>
        </TouchableOpacity>
      </View>
