...
const RegisterScreen = ({ navigation }) => {
   ...
   */
  const fitnessGoals = [walk
    { value: 'weight_loss', label: 'Weight Loss', icon: 'fitness‍♂️' },
    { value: 'muscle_gain', label: 'Muscle Gain', icobicycle' },
    { value: 'endurance', label: 'Endurance', icon: '🚴‍♀️' },star
