...
async function init() {
  try {
    ...
    // 2. Create Sample Workouts with Exercises
    const sampleWorkouts = [
      {
        ...
        exercises: [
          { name: 'Push-ups', sets: 3, reps: 12, weight: null, duration: null, restTime: 60, difficulty: 'intermediate', completed: true },
          { name: 'Squats', sets: 4, reps: 10, weight: 50.00, duration: null, restTime: 90, difficulty: 'intermediate', completed: true },
          { name: 'Bench Press', sets: 3, reps: 8, weight: 60.00, duration: null, restTime: 120, difficulty: 'intermediate', completed: true },
          { name: 'Plank', sets: 3, reps: null, weight: null, duration: 60, restTime: 30, difficulty: 'beginner', completed: true }
        ]
      },
      {
        name: 'Cardio Blast',
        ...
        difficulty: 'intermediate',
        exercises: [
          { name: 'Running', sets: null, reps: null, weight: null, duration: 1800, distance: 5.00, calories: 400, restTime: null, difficulty: 'intermediate', completed: true }
        ]
      },
      {
        name: 'HIIT Challenge',
        ...
        difficulty: 'advanced',
        exercises: [
          { name: 'Burpees', sets: 4, reps: 15, weight: null, duration: null, restTime: 30, difficulty: 'advanced', completed: true },
          { name: 'Mountain Climbers', sets: 4, reps: 20, weight: null, duration: null, restTime: 30, difficulty: 'intermediate', completed: true },
          { name: 'Jump Squats', sets: 4, reps: 12, weight: null, duration: null, restTime: 30, difficulty: 'intermediate', completed: true },
          { name: 'High Knees', sets: 4, reps: 30, weight: null, duration: null, restTime: 30, difficulty: 'beginner', completed: true }
        ]
      },
      {
        name: 'Yoga Flow',
        ...
        difficulty: 'beginner',
        exercises: [
          { name: 'Sun Salutation', sets: 5, reps: null, weight: null, duration: 300, restTime: 30, difficulty: 'beginner', completed: true },
          { name: 'Warrior Pose', sets: 3, reps: null, weight: null, duration: 120, restTime: 20, difficulty: 'beginner', completed: true },
          { name: 'Tree Pose', sets: 3, reps: null, weight: null, duration: 90, restTime: 20, difficulty: 'beginner', completed: true }
        ]
      },
      {
        name: 'CrossFit WOD',
        ...
        difficulty: 'advanced',
        exercises: [
          { name: 'Deadlifts', sets: 5, reps: 5, weight: 80.00, duration: null, restTime: 180, difficulty: 'advanced', completed: true },
          { name: 'Box Jumps', sets: 4, reps: 10, weight: null, duration: null, restTime: 60, difficulty: 'intermediate', completed: true },
          { name: 'Kettlebell Swings', sets: 4, reps: 15, weight: 16.00, duration: null, restTime: 60, difficulty: 'intermediate', completed: true }
        ]
      }
    ];
    ...
    console.log(`✅ Created ${workoutCount} sample workouts with exercises`);
