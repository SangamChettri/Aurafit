...
const targetStr = `  }, [personalizedWorkout, templateWorkout, exercises, setValue]);
        )}
      </View>
...
const insertPoint = content.indexOf(targetStr);
if (insertPoint !== -1) {
  content = content.replace(targetStr, `  }, [personalizedWorkout, templateWorkout, exercises, setValue]);
` + missingCode + `
        )}
      </View>
      <Icon name="add-circle-outline" size={24} color="#0ea5e9" />
